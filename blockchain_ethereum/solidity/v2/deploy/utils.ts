...
export const deployContract = async (contractArtifactName: string, constructorArguments?: any[], options?: DeployContractOptions) => {
  ...
  try {
    ...
    log(`- Verify error message: ${error.message}`);
  }

  return contract;
}

export const estimateGas = async (contractArtifactName: string, constructorArguments?: any[], options?: DeployContractOptions) => {
